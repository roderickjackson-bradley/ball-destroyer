...
var circleScene = [
    ...
    staticBuildingCircleForScenery(2, 3, 0, 2, 1),
    staticBuildingCircleForScenery(6, 6, 0, 3, 1),
    staticBuildingCircleForScenery(10, 9, 0, 2, 1),
    staticBuildingCircleForScenery(14, 12, 0, 7, 1),
    staticBuildingCircleForScenery(18, 15, 0, 7, 3),
    staticBuildingCircleForScenery(2, 0, 0, 2, 1),
    staticBuildingCircleForScenery(6, 0, 1, 3, 1),
    staticBuildingCircleForScenery(10, 0, -0.2, 2, 1),
    staticBuildingCircleForScenery(14, 1, 0, 7, 1),
    staticBuildingCircleForScenery(18, 15, 0, 7, 3),
    staticBuildingCircleForScenery(22, 3, 0, 2, 1),
    staticBuildingCircleForScenery(16, 1, 1, 3, 1),
    staticBuildingCircleForScenery(20, 4, -1, 2, 1),
    staticBuildingCircleForScenery(18, 15, -0.3, 7, 3),
    staticBuildingCircleForScenery(2, 3, 1, 2, 1),
    staticBuildingCircleForScenery(6, 6, 0, 3, 1),
    staticBuildingCircleForScenery(20, 9, 0, 2, 1),
    staticBuildingCircleForScenery(24, 2, 0, 7, 1),
    staticBuildingCircleForScenery(6, 6, 0, 3, 1),
    staticBuildingCircleForScenery(10, 9, 0, 2, 1),
    staticBuildingCircleForScenery(14, 12, 0, 7, 1),
    staticBuildingCircleForScenery(18, 15, 0, 7, 3),
    ...
    staticBuildingCircleForScenery(16, 1, 1, 3, 1),
    staticBuildingCircleForScenery(20, 4, -1, 2, 1),
    staticBuildingCircleForScenery(4, 2, 0.5, 7, 1),
    staticBuildingCircleForScenery(18, 15, -0.3, 7, 3),
    staticBuildingCircleForScenery(2, 3, 1, 2, 1),
    staticBuildingCircleForScenery(6, 6, 0, 3, 1),
    staticBuildingCircleForScenery(20, 9, 0, 2, 1),
    staticBuildingCircleForScenery(24, 2, 0, 7, 1),
    staticBuildingCircleForScenery(28, 15, 0, 7, 3),
    staticBuildingCircleForScenery(18, 15, 0, 7, 3),
    staticBuildingCircleForScenery(2, 0, 0, 2, 1),
    staticBuildingCircleForScenery(6, 0, 1, 3, 1),
    staticBuildingCircleForScenery(10, 0, -0.2, 2, 1),
    ...
    staticBuildingCircleForScenery(10, 9, 0, 2, 1),
    staticBuildingCircleForScenery(14, 12, 0, 7, 1),
    staticBuildingCircleForScenery(18, 15, 0, 7, 7),
    staticBuildingCircleForScenery(2, 0, 0, 2, 1),
    staticBuildingCircleForScenery(6, 0, 1, 3, 1),
    staticBuildingCircleForScenery(10, 0, -0.2, 2, 1),
    staticBuildingCircleForScenery(14, 1, 0, 7, 1),
...
staticBuildingBlockForScenery(6, 6, 0, 3, 1),
staticBuildingBlockForScenery(20, 9, 0, 2, 1),
staticBuildingBlockForScenery(24, 2, 0, 7, 1),
staticBuildingBlockForScenery(28, 15, 0, 7, 3),
staticBuildingBlockForScenery(18, 15, 0, 7, 3),
staticBuildingBlockForScenery(2, 0, 0, 2, 1),
staticBuildingBlockForScenery(6, 0, 1, 3, 1),
staticBuildingBlockForScenery(10, 0, -0.2, 2, 1),
...
function staticBuildingBlockForScenery(x, y, angle, width, height) {
    ...
    var body = new p2.Body({
        mass: 1,//(function(){}), I want to add a binary function that turns gravity on and off
        position:[x, 115],
        angle: angle
    });
    body.addShape(shape);
